...
export const routes: Routes = [
  ...
  // ✅ Layout para TODAS las rutas protegidas
  {
    ...
    children: [
      {
        path: 'matriz',
        loadComponent: () => import('./features/matriz/matriz.component').then(m => m.MatrizComponent),
      ...
      {
        path: 'titulos-h',
        loadComponent: () => import('./features/titulo-h/titulo-h.component').then(m => m.TituloHComponent),
        data: { titleSmall: 'Títulos H', titleLarge: 'Crear filas (Títulos Horizontales)' }
      },
      {
        path: 'titulos-v',
        loadComponent: () => import('./features/titulo-v/titulo-v.component').then(m => m.TituloVComponent),
        data: { titleSmall: 'Títulos V', titleLarge: 'Crear columnas (Títulos Verticales)' }
      },
      {
        path: 'cargos',
        loadComponent: () => import('./features/cargos/cargos.component').then(m => m.CargosComponent),
        data: { titleSmall: 'Cargos', titleLarge: 'Gestión de Cargos' }
      },
      {
        path: 'crear-celdas',
        loadComponent: () => import('./features/crear-celdas/crear-celdas.component').then(m => m.CrearCeldasComponent),
